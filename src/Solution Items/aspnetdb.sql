...
** and a Membership entry are added for any application.
*/
/**********************************************************************/
...
INSERT INTO [aspnet_Users]([ApplicationId],[UserId],[UserName],[LoweredUserName],[IsAnonymous],[LastActivityDate]) VALUES('60e17a52-7f43-41cd-8d08-6125d37a624b',
'13877c8b-507f-4ae4-81bd-c0c81e94658d','leroy','leroy',0,getdate())
go

INSERT INTO [aspnet_Membership]([ApplicationId],
[UserId],[Password],[PasswordFormat],[PasswordSalt],
[Email],[LoweredEmail],[IsApproved],[IsLockedOut],
...
VALUES
('60e17a52-7f43-41cd-8d08-6125d37a624b',
'13877c8b-507f-4ae4-81bd-c0c81e94658d','If/etWLO1zQhe3LoK8hdJ8Nlv3Y=',1,
'fDnhbskomi1ZiUKyRSDkWQ==',
'leroy@zen.com','leroy@zen.com',1,0,
getdate(),getdate(),getdate(),
'1/1/1754 12:00:00 AM',0,'1/1/1754 12:00:00 AM',
0,'1/1/1754 12:00:00 AM')
go
